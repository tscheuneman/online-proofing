...
@section('content')
    ...
    <br>
    <form method="POST" action="{{ url('/admin/customers') }}" enctype="multipart/form-data" id="submit">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="org" name="org" value="{{Request::old('org')}}" required>
        </div>
